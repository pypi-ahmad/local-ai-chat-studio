...
// Evidence route: full-page view of retrieved sources (via EvidenceSourceList, which
// enforces the trusted/untrusted toggle rule) plus a read-only integrity chain listing
// receipt hashes for past runs. `activity` and `plan` are fetched by the app and passed
// in; this page renders them only.
