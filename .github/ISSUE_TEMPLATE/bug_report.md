---
name: 🐛 Bug report
about: Something isn't working the way you expect — let's fix it
title: "[bug] "
labels: bug
assignees: ""
---
...
Paste the relevant output from the launcher console or the `chat-studio` terminal. Remove any API keys or credentials before pasting.
