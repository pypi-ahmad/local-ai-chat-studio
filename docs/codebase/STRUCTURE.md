...
| `frontend/src/` | React workspace, rich Markdown/LaTeX/Mermaid rendering, capability-aware model selection, context/evidence inspection, 2–4 model comparison, design system, typed API client |
